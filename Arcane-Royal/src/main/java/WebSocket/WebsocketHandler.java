...
public class WebsocketHandler extends TextWebSocketHandler {
	...
	/*
	 *  Convierte a null el espacio en el arreglo donde se encuentra la sesion y envía un mensaje de que se ha desconectado 
	 *  el otro jugador. Si las dos sesiones de esa pareja se encuentran desocupadas, elimina esa pareja de la lista
	 */
